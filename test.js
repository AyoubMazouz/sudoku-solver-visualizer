const _testBacktrackAlgorithm = (sudoku, iteration) => {
    ...
    console.log('########################################')
    console.log(`Is it completely solved: ${!getValidPosition(board)}`)
    for (let y = 0; y < board.length; y++) {
        for (let x = 0; x < board[0].length; x++) {
            if (board[y][x] !== solution[y][x]) {
                console.log(`#>Difference:`)
                console.log(`Solved board     : ${board[y][x]}`)
                console.log(`Pre-made solution: ${solution[y][x]}`)
                console.log(`At               : (${y}, ${x})`)
                howManyAreDifferent++;
            }
        }
    }
    console.log(`Are they the same      : ${howManyAreDifferent === 0}`)
    console.log(`#>How many are different: ${howManyAreDifferent}`)
    console.log(`Unsolved board    :`)
    console.log(unsolvedBoard)
    console.log(`Pre-made solution :`)
